        ...
        <div class="row">
          ...
          <div class="col">
            <input 
              type="text" 
              class="form-control" 
              placeholder="Pesquisar pokémon pela propriedade watch" 
  ...
  export default {
    ...
    methods: {
      ...
      analisarPokemon(pokemon){
        ...
        //verificar se o pokémon atual é diferente do pokémon clicado
        ...
        //se a ação for de ocultar o pokémon (quando o atributo "exibir" for false)
        //se a ação recursiva não for chamada (this.analisarPokemon(pokemon))
    ...
    watch: {
      ...
      ordenacao(valorNovo){
        ...
        } else if(valorNovo == 2){ //ID decrescente
          this.pokemons.sort((proximo, atual) => {
            //método sort()
            //return 1 para indicar que a ordem está correta
            //return -1 para indicar que a ordem está incorreta
        ...
        } else if(valorNovo == 4){ //Z-A (utilizando o localeCompare())
          this.pokemons.sort((proximo, atual) => {
            //let resultado1 = atual.nome.localeCompare(proximo.nome) //essas duas strings serão comparadas gerando um retorno
            //let resultado2 = proximo.nome.localeCompare(atual.nome) //essas duas strings serão comparadas gerando um retorno

            //localeCompare() retorna -1, 1 ou 0
            ...
            //0 indica que os valores forem iguais
            //retornos ideais para o método sort()

            //com isso em mente, podemos dar o retorno:
